            ...
            swiper = new Swiper('.sectionSlider.swiper-container', {
                ...
                on: {
                    init: function () {
                        ...
                        var blackListes = [2, 3, 5, 7, 9, 10, 11, 13, 14, 15, 16, 17, 18, 19, 21, 23, 25];
                        if (blackListes.includes(activeIndex)) {
                            $('.swiper-pagination-bullet').removeClass("swiper-clr-white").addClass("swiper-clr-black");
                    ...
                    slideChangeTransitionStart: function () {
                        ...
                        var blackListes = [2, 3, 5, 7, 9, 10, 11, 13, 14, 15, 16, 17, 18, 19, 21, 23, 25];
                        if (blackListes.includes(index)) {
                            $('.swiper-pagination-bullet').removeClass("swiper-clr-white").addClass("swiper-clr-black");
                            $('.black').removeClass("hide");
                            $(' .white').addClass("hide");
                        } else {
                            $('.swiper-pagination-bullet').removeClass("swiper-clr-black").addClass("swiper-clr-white");
                            $('.black').addClass("hide");
                        ...
                        $('.swiper-pagination-bullet:nth-child(' + (index + 1) + ')').addClass('swiper-pagination-bullet-active');
...
// Robust custom vertical swipe logic for mobile
        ...
        $(document).on('click', '.swiper-pagination-bullet', function (e) {
            ...
            $('.swiper-pagination-bullet-active').removeClass('swiper-pagination-bullet-active');
            $('.swiper-pagination-bullet:nth-child(' + (targetIndex + 1) + ')').addClass('swiper-pagination-bullet-active');
            return false;
        });
